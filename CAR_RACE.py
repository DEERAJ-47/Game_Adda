...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\1img\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('.\\1img\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load(".\\1img\\back_ground.jpg")
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- DEERAJ')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("DEERAJ", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("deerajsimha@gmail.com", True, self.white)
